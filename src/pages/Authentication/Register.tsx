            ...
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div className="mb-5">
                  <button
                    type="submit"
                    className="w-full flex justify-center items-center cursor-pointer rounded-lg border border-primary bg-primary p-4 text-white transition hover:bg-opacity-90"
