...
export async function mountAgravoLineData(setAgravoLineSeries: Function, yearSelected: string) {
    const apiData = await getApiData(`/notifications/count/epidemiologicalWeek?year=${yearSelected}`)
